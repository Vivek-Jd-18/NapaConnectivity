                                ...
                                <div className={styles.boxinnrcont}>
                                    <Link href="#">
                                        <a href='#' className={`${styles.apernt} hovereffect`} >
                                            <Image src='/img/tutorial_img01.png' height="373px" width="372px" alt='' className="evmtimg" />
                        ...
                        <div className={styles.CustomGrid}>
                            <div  className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    <Link href="#">
                                        <a href='#' className={`${styles.apernt} hovereffect`}>
                                            <Image src='/img/tutorial_img02.png' height="373px" width="372px" alt='' className="evmtimg" />
                                            <div className={styles.linkupcontent}>
                                                <div className={styles.tutoril}>
                                                    <img src='/img/tutorl_ic.svg' alt='' className='' />
                                                    <p>12 tips</p>
                        ...
                        <div className={styles.CustomGrid}>
                            <div  className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    <Link href="#">
                                        <a href='#' className={`${styles.apernt} hovereffect`}>
                                            <Image src='/img/tutorial_img03.png' height="373px" width="372px" alt='' className="evmtimg" />
                                            <div className={styles.linkupcontent}>
                                                <div className={styles.tutoril}>
                                                    <img src='/img/tutorl_ic.svg' alt='' className='' />
                                                    <p>7 tutorials</p>
                        ...
                        <div className={styles.CustomGrid}>
                            <div  className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    <Link href="#">
                                        <a href='#' className={`${styles.apernt} hovereffect`}>
                                            <Image src='/img/tutorial_img04.png' height="373px" width="372px" alt='' className="evmtimg" />
                                            <div className={styles.linkupcontent}>
                                                <div className={styles.tutoril}>
                                                    <img src='/img/tutorl_ic.svg' alt='' className='' />
                                                    <p>4 tips</p>
                        ...
                        <div className={styles.CustomGrid}>
                            <div  className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    <Link href="#">
                                        <a href='#' className={`${styles.apernt} hovereffect`}>
                                            <Image src='/img/tutorial_img05.png' height="373px" width="372px" alt='' className="evmtimg" />
                                            <div className={styles.linkupcontent}>
                                                <div className={styles.tutoril}>
                                                    <img src='/img/tutorl_ic.svg' alt='' className='' />
                                                    <p>10 tutorials</p>
