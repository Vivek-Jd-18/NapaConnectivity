...
import styles from './CreateNewSwappingThree.module.scss';
import Link from 'next/link';

export default function CreateNewSwappingThree() {
    const options = [
                                ...
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_01.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_03.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_05.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_06.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_07.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/Offers_by_Users_08.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
