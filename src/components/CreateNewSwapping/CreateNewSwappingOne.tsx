...
import styles from './CreateNewSwappingOne.module.scss';
import Link from 'next/link';

export default function CreateNewSwappingOne() {
    const options = [
                                ...
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping01.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping02.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping03.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping04.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping05.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping06.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping07.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
                            ...
                            <div className={styles.TipsTulsOverlay}>
                                <div className={styles.boxinnrcont}>
                                    {/* <Link href="#"> */}
                                        <div className={`${styles.apernt} hovereffect`}>
                                            <Image
                                                src="/img/createnew_swapping08.png"
                                                height="372px"
                                                width="282px"
                                                alt=""
                                                className="evmtimg"
