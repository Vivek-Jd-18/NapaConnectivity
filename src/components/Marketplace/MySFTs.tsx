...
export default function MySFTs() {
    const options = [
  ...
  return (
    <>
            ...
            <div className={styles.tipandtotolmain}>
                <div className="select_main select_main_NFT">
                    <Select
                        options={options}
                        // menuIsOpen={true}
                ...
                <div className={styles.buttonperntAj}>
                    ...
                    <button className={styles.CreateNFTBtn}><Link href='/create-new-sfts'><a>Create New SFT</a></Link></button>
                </div>
            </div>
