...
import styles from './LaunchpadDatals.module.scss';
import Link from 'next/link';

export default function LaunchpadDatals() {
      const optionstow = [
                        ...
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img01.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img02.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img03.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img04.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img05.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img06.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img07.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
                    ...
                    <div className={styles.TipsTulsOverlay}>
                        <div className={styles.boxinnrcont}>
                            <Link href="#">
                                <a href="#" className={`${styles.apernt} hovereffect`}>
                                    <Image
                                        src="/img/lnchpad_dtls_img08.png"
                                        height="372px"
                                        width="282px"
                                        alt=""
                                        className="evmtimg"
