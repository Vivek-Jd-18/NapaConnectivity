...
import styles from './CoBatchingPoolFour.module.scss';

import { Avatar, NapaIcon, TimeIcon } from '../assets';

type CoBatchingPoolsCardProps = {};

const CoBatchingPoolFour: NextPage<CoBatchingPoolsCardProps> = () => {
  return (
    <>
    <div className={`${styles.cardContainer} ${styles.DesktopcardContainer}`}>
      ...
      <div className={styles.rightSide}>
        ...
        <div className={styles.timeContainer}>
          ...
          <span className={styles.time}>Aug 29, 2022  12:00</span>
        </div>
        <div className={styles.amountContainer}>
          ...
          <div className={styles.amountInnerContainer}>
            ...
            <span className={styles.amount}>0.25 - 4.00</span>
          </div>
        </div>
...
export default CoBatchingPoolFour;
