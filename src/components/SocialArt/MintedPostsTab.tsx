    ...
    <div className={styles.MintedHead}>
        ...
        <div className={styles.RightHeader}>
            ...
            <div className={styles.RightThreeBtn} id="nav-tab" role="tablist">
                ...
                <button className={`${styles.GridBtn} nav-link active`} id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                    <Image src="/img/grid4_icon.svg" alt="" width={24} height={24} />
                </button>
                <button className={`${styles.ListBtn} nav-link`} id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                    <Image src="/img/rows_icon.svg" alt="" width={24} height={24} />
                </button>
            </div>
        </div>
    </div>
    <div className={active ? `${styles.FilterBox} ${styles.active}` : `${styles.FilterBox}`}>
